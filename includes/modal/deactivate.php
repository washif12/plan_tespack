    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-plan">
                <h5 class="col-11 text-center modal-title mt-0" id="myModalLabel"><i class="mdi mdi-delete"></i>&nbsp; Deacticate User</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-plan deactivate_btn">Deacticate</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div>