                ...
                <div class="card login-holder col-xs-12 col-sm-10 col-md-8 col-lg-6 col-xl-5">
                    <div class="card-body">
                        ...
                        <h1 class="text-center" style="margin-top: -100px;">
                            <a href="#" class="logo logo-admin"><img class="img-login" src="assets/images/plan-logo.png" height="150" alt="logo"></a>
                        </h1>
                        ...
                        <div class="p-3">
                            ...
                            <form class="form-horizontal m-t-10 text-center" action="/backend/signin.php" method="post">
                                ...
                                <div class="form-group m-t-20 row" style="margin:auto">
                                    <div class="col-6 text-left">
                                        <!--<div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label text-white font-18" for="customControlInline">Remember me</label>
                                        </div>-->
                                    </div>
                                    <div class="col-6 text-right">
                                        <a href="forgot-pass.php" class="text-warning font-18">Forgot password?</a>
                                    </div>
                                </div>

                                <div class="form-group row m-t-40">
                                    <div class="col-12 text-center">
                                        <button name="submit" class="btn btn-lg w-md waves-effect waves-light font-32" style="width: 50%;background-color: #f2c400;color: black;" type="submit"><b>LOGIN</b></button>
                                    </div>
                                </div>
                            </form>
                        </div>
