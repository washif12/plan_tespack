...
function sendVerificationEmail($userEmail, $userName, $userRole) 
{
  ...
  try {
    ...
    $transport = Transport::fromDsn('smtp://washif.hossain@tespack.com:mtfpcorgvlcujdmt@smtp.gmail.com:587');
    ...
    $message = (new Email())
        ...
        <body class="body" style="padding:0 !important; margin:0 !important; display:block !important; min-width:100% !important; width:100% !important; -webkit-text-size-adjust:none;">
          <table width="90%" border="0" cellspacing="0" cellpadding="0" style="background-image: url(http://localhost/Plan_Int_New/assets/images/emails/invite_bg.png);background-size: cover;background-repeat: no-repeat;margin: auto;">
            <tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <th class="column-top" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;">
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td class="img m-center" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="http://localhost/Plan_Int_New/assets/images/emails/smb.png" width="200"/></td>
                                    </tr>
                                  </table>
                                </th>
                              ...
                              <tr>
                                <td class="p30-15" style="padding: 30px 30px;">
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      <td class="text pb20" style="color:#000000; font-family:Arial,sans-serif; font-size:14px; line-height:26px; text-align:left; padding-bottom:20px;"><text>http://localhost/Plan_Int_New/register.php?role='.$userRole.'&email='.$userEmail.'&name='.$userName.'</text></td>
                                    </tr>
                                    <tr>
    ...
    echo 'Email sent successfully.';
        ...
        echo $e->getMessage();
          if( !$e->getCode() ) {
              ...
              sendVerificationEmail($userEmail, $userName, $userRole);
          } else {
