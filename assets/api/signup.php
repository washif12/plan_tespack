...
function sendVerificationEmail($verifyToken, $userName, $userRole, $userEmail) 
{
  ...
  $message = (new Email())
      ...
      <body class="body" style="padding:0 !important; margin:0 !important; display:block !important; min-width:100% !important; width:100% !important; -webkit-text-size-adjust:none;">
        <table width="90%" border="0" cellspacing="0" cellpadding="0" style="background-image: url(https://tesinsight.com/assets/images/emails/verify_bg.png);background-size: cover;background-repeat: no-repeat;margin: auto;">
          <tr>
                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <th class="column-top" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td class="img m-center" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="https://tesinsight.com/assets/images/emails/smb_tick.png" width="200"/></td>
                                  </tr>
                                </table>
                              </th>
    ...
    elseif(strlen($fname) < 3):
        ...
        try{
            ...
            if($check_email_stmt->rowCount()):
                ...
                if(sendVerificationEmail($token, $fname, $role_name, $email)):
